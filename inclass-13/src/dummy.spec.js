...
describe('Validate login', () => {
    ...
    it('should update the headline', (done) => {
        ...
        var mock_headline = { username: 'testing', headline: 'mock_headline' }
        ...
        updateHeadline(mock_headline)
            .then(_=> {
                expect(div.innerHTML).to.eql('you are logged in as testing "mock_headline"')
            })
            .then(done)
            .catch(done)
